...
import { Publication, PublicationAuthor } from '../data/publications';
...
const PublicationItem = ({ pub, index }: PublicationItemProps) => (
  <motion.div
    key={pub.id}
    className="pub-item"
  ...
  >
    ...
    <div className="pub-content">
      ...
      <div className="pub-links">
        ...
        {pub.codeLink && (
          <a href={pub.codeLink} target="_blank" rel="noopener noreferrer" className="pixel-link">
            Code →
          </a>
        )}
        {pub.dataLink && (
          <a href={pub.dataLink} target="_blank" rel="noopener noreferrer" className="pixel-link">
            Data →
          </a>
        )}
      </div>
